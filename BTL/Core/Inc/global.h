...
//UART
// Định nghĩa các hằng số điều khiển đèn giao thông
#define INCREMENT_RED_TIME 1
#define DECREMENT_RED_TIME 2
#define SWITCH 3
#define RESETALL 4
#define INCREMENT_GREEN_TIME 5
#define DECREMENT_GREEN_TIME 6
#define INCREMENT_YELLOW_TIME 7
#define DECREMENT_YELLOW_TIME 8
#define SWITCH_TO_TUNING_MODE 9
