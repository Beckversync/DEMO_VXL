...
// HTML for Button controls
char *Button1 = "<p><a class=\"button button-on\" href=\"/button1\">Button 1</a></p>";
char *Button2 = "<p><a class=\"button button-on\" href=\"/button2\">Button 2</a></p>";
char *Button3 = "<p><a class=\"button button-on\" href=\"/button3\">Button 3</a></p>";
